...
//const defaults = [ "Bear Claws", "Blue Mountain Flower", "Canis Root", "Chaurus Eggs", "Chicken's Egg", "Deathbell", "Glow Dust", "Hanging Moss", "Ice Wraith Teeth", "Imp Stool", "Large Antlers", "Luna Moth Wing", "Nightshade", "Nirnroot", "River Betty", "Salt Pile", "Spider Egg", "Swamp Fungal Pod", "Vampire Dust"];
  const defaults = ["Blue Butterfly Wing", "Blue Mountain Flower", "Butterfly Wing", "Chorred Skeever Hide", "Chicken's Egg", "Dragon's Tongue", "Elves Eor", "Fly Amanita", "Imp Gall", "Jazbay Grapes", "Lavender", "Mora Fapinella", "Nightshade", "Nirnroot", "Purple Mountain Flower", "Red Mountain Flower", "Salmon Roe", "Salt Pile", "Slaughterfish Egg", "Snowherries", "Thistle Branch", "Tundra Cotton", "Wheat", "White Cap"];
